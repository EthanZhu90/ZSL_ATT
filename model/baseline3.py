...
import math
import h5py
## this baseline uses the extracted text feature by reet.

class baseline_model3():
    ...
    def model(self):
        ...
        phrase_feat = tf.placeholder("float32", [self.phrase_size, 1024])
        ...
        cls_weight = tf.matmul(self.Wxt, tf.transpose(phrase_feat))
