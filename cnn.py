...
sys.path.append("/home/ethan/caffe/python")
...
# default # but we use resnet
deploy = '/home/ethan/caffe/models/bvlc_reference_caffenet/deploy.prototxt'
model = '/home/ethan/caffe/models/bvlc_reference_caffenet/bvlc_reference_caffenet.caffemodel'
mean = '/home/ethan/caffe/python/caffe/imagenet/ilsvrc_2012_mean.npy'
...
class CNN(object):
    ...
    def get_features(self, image_list, layers='fc7', layer_sizes=[4096]):
        ...
        #starts = np.arange(0, len(image_list), self.batch_size)
        #ends = starts + self.batch_size
